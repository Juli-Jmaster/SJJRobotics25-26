...
@Configurable
class Paths {
    public static Pose startPose = new Pose(111, 132.5, Math.toRadians(270));
    ...
    public static Pose pickup1EndPose = new Pose(126, 83.5, Math.toRadians(0));
    ...
    public static Pose clearGatePose = new Pose(129.5, 75, Math.toRadians(0));
    public static Pose controlClearGatePose = new Pose(105, 70, Math.toRadians(0));
