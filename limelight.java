        ...
        while (opModeIsActive()) {
            ...
            if (result != null) {
                if (result.isValid()) {
                    ...
                    double distance = ((aprilTagCenterHeight-cameraCenterHeight)/Math.tan(angleToGoalRad))*Math.cos(newtX);//

                    double errorDis = 48-distance;
                    errorDis*=-1;
                    telemetry.addData("yesy", result.getTy());
                    telemetry.addData("yesx", result.getTx());
                    telemetry.addData("yesx", result.getTx());
                    telemetry.addData("distance", distance);
                    telemetry.addData("rotate", rotate);
                    telemetry.addData("d", errorDis);
                    telemetry.update();
