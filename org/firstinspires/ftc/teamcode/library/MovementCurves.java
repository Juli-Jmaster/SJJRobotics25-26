...
public class MovementCurves {
    ...
    public static double movementCurves(int movementType, double x) {
        return movementCurves(movementType, x, 1,  RobotConstants.minimumPowerStraight*2);
    }
    public static double movementCurves(int movementType, double x,  double minimumPower) {
        return movementCurves(movementType, x, 1,  minimumPower);
    }
    public static double movementCurves(int movementType, double x, double mulituyer, double minimumPower){
        double power;
        switch (movementType) {
