...
public class Constants {
    ...
    private static double forwardVelocity = 69.05;
    private static double strafeVelocity = 54.45;
    private static double forwardDeceleration = -27.3;
    private static double lateralZDeceleration = -71.53;
